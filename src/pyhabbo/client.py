...
from pyhabbo.resources.lists import ListsResource
from pyhabbo.resources.marketplace import MarketplaceResource
...
class HabboClient:
    def __init__(
        ...
        *,
        ...
        self._marketplace = MarketplaceResource(self._transport)
